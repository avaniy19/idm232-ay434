 ...
 * @return object - mysqli_result
 */
function edit_user($first_name_value, $last_name_value, $servings_value, $ingredients_value, $id_value)
{
    global $db_connection;
    $query = 'UPDATE users';
    $query .= " SET first_name = '{$first_name_value}', last_name = '{$last_name_value}', email = '{$servings_value}', phone = '{$ingredients_value}'";
